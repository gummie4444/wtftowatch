var app = angular.module( 'myApp', ['photoService'] );
...
app.controller( 'MainCtrl', function( $scope,photoService) {
...
*/
    ...
    var bla = keys[Math.floor(Math.random() * keys.length)];
...
//TODO GERA ÞETTA FLOTT EKIK DREP
